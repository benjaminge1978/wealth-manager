  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setTimeout(() => {
          downloadPDF('interview-questions');
        }, 1000);
      } else {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="max-w-2xl w-full">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Success! Your Questions Guide is Ready</CardTitle>
          ...
          <CardContent className="text-center space-y-6">
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              ...
              <ul className="text-sm text-green-700 space-y-1">
                ...
                <li>✓ We've added you to our weekly expert insights</li>
                <li>✓ No spam - unsubscribe anytime</li>
              </ul>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button onClick={() => downloadPDF('interview-questions')} variant="outline">
                Download PDF Again
              </Button>
